...
class ImageTransformer:
    ...
    def transform_image(
        ...
        output_size=(1024, 756),
        thumbnail_size=(256, 192)
    ):
        """
        ...
        print(f"Aligning: {image_name}.png")
       ...
       # Create and save thumbnail
        ...
        thumbnail_path = Path(thumbnail_dir) / f"{image_name}.png"
        cv2.imwrite(str(thumbnail_path), thumbnail)

        return output_path

def transform_images(imgs, src_dir, dest_dir, thumbnail_dir, coords_file):
